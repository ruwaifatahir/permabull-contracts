...
contract WhitelistedRole is Ownable {
    ...
    modifier onlyRebaseAdmin() {
        require(
            isRebaseAdmin(msg.sender),
            "WhitelistedRole: caller does not have the Rebase role"
        );
        _;
    }
...
contract LockPayV2 is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    address public liquidityReceiver =
        0x076e59C9E2E5fE0fBE2D6570a3B209b916213749;
    address public treasuryReceiver =
        0xE8d17507977Aed6504Ca83ACa417FAd8e6f2cC47;
    address public riskFreeValueReceiver =
        0x3fb6d1230345Db2098fa229541cE8B7194BEd9F8;
    ...
    address public holdersRewardReceiver =
        0x75e31EdF98746018139940FeCE24Ea3141728b49;
    ...
    function _transferFrom(
        ...
        bool AllowedTransfer = _isWhiteListedUser[sender] ||
            _isWhiteListedUser[recipient];
    ...
    function setWhiteListedUser(address _addr, bool _value)
        public
        onlyWhitelisted
    {
    ...
    function setSellLimit(uint256 _addr) external onlyWhitelisted {
        SellLimit = _addr;
    }
    ...
    function setRebaseFrequency(uint256 _rebaseFrequency)
        external
        onlyWhitelisted
    {
